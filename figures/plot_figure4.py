...
filename = np.array([['../data/figure4/bias_a', '../data/figure4/bias_b', '../data/figure4/bias_c', '../data/figure4/bias_d'], ['../data/figure4/bias_e', '../data/figure4/bias_f', '../data/figure4/bias_g', '../data/figure4/bias_h'], ['../data/figure4/bias_i', '../data/figure4/bias_j', '../data/figure4/bias_k',  '../data/figure4/bias_l'],  ['../data/figure4/bias_m', '../data/figure4/bias_n', '../data/figure4/bias_o', '../data/figure4/bias_p']])
...
for ax in [ax_cbar1, ax_cbar2, ax_cbar3]:
